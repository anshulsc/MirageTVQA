...
DATASET_JSON_PATH = "/data/asca/MirageTVQA/data/processed/probes/probe_multilingual_en_zh_cn.json"  # Path to your JSON file
...
OUTPUT_DIR = Path(f"outputs/{MODEL_ID.split("/")[-1]}/multilingual_en_zh_cn/")
